...
const Projects = () => {
  ...
  return (
    ...
    >
          ...
          <div key={index} className={styles.projectCard}>
            <div style={{ marginBottom: 50 }}>
              ...
              >
                ...
                <p style={{ marginRight: 5 }}>GitHub:</p>
                <a
                  href={project.github}
                  target="_blank"
                  rel="noreferrer"
            ...
            <Carousel autoPlay showThumbs={false}>
              {project.imageLinks.map((link: string, index: number) => (
                <div
                  ...
                  style={{ height: 400 }}
                  onClick={() => {
                    setCurrentImages(project.imageLinks);
                    setVisibleModal(true);
                  }}
                >
                  {/* <Link href="/_next/image?url=%2F..%2Fpublic%2Fimages%2Fwhatsapp-clone.jpg">
      ...
      >
        <Carousel autoPlay showThumbs={false}>
          {currentImages.map((link: string, index: number) => (
            <div
              key={index}
              className={
